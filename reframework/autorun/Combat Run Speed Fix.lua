...
--                      // Default values //
local defaults = {
    walk_speed_rate = 1.100,  -- (1.100) _WalkSpeedRate
    run_speed_rate = 1.150,   -- (1.150) _RunSpeedRate
    narrow_walk_rate = 1.100,  -- (1.000) _NarrowWalkSpeedRate
    narrow_run_rate = 1.150,   -- (1.000) _NarrowRunSpeedRate
    aim_walk_rate = 1.100,    -- (1.000) _HoldWalkSpeedRate
    combat_walk_rate = 1.100, -- (0.900) _BattleWalkSpeedRate
    combat_run_rate = 1.150    -- (0.900) _BattleRunSpeedRate
}

local field_mapping = {
    walk_speed_rate = "_WalkSpeedRate",
    run_speed_rate = "_RunSpeedRate",
    narrow_walk_rate = "_NarrowWalkSpeedRate",
    narrow_run_rate = "_NarrowRunSpeedRate",
    aim_walk_rate = "_HoldWalkSpeedRate",
    combat_walk_rate = "_BattleWalkSpeedRate",
    combat_run_rate = "_BattleRunSpeedRate"
}
...
local function update_speed()
    ...
    if player_equip then
        ...
        local function set_values(param)
            param:set_field("_WalkSpeedRate", defaults.walk_speed_rate)            -- (1.100) _WalkSpeedRate
            param:set_field("_RunSpeedRate", defaults.run_speed_rate)              -- (1.150) _RunSpeedRate
            param:set_field("_NarrowWalkSpeedRate", defaults.narrow_walk_rate)     -- (1.000) _NarrowWalkSpeedRate
            param:set_field("_NarrowRunSpeedRate", defaults.narrow_run_rate)       -- (1.000) _NarrowRunSpeedRate
            param:set_field("_HoldWalkSpeedRate", defaults.aim_walk_rate)          -- (1.000) _HoldWalkSpeedRate
            param:set_field("_BattleWalkSpeedRate", defaults.combat_walk_rate)     -- (0.900) _BattleWalkSpeedRate
            param:set_field("_BattleRunSpeedRate", defaults.combat_run_rate)       -- (0.500) _BattleRunSpeedRate
        end
